...
<p align="center">
  ...
  <a href="https://github.com/Gidroponik/AudioManagerPro/releases"><img src="https://img.shields.io/github/downloads/Gidroponik/AudioManagerPro/total?style=flat-square&label=%D1%81%D0%BA%D0%B0%D1%87%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D0%B9&color=3b82f6" alt="Скачивания"></a>
...
Релиз собирается автоматически в GitHub Actions. Достаточно поставить тег:
...
Или откройте **Actions → Release → Run workflow** и укажите версию, например `1.0.1`. Через пару минут в [Releases](https://github.com/Gidroponik/AudioManagerPro/releases) появится `AudioManagerPro.exe` с контрольной суммой, а установленные копии приложения предложат обновиться.
